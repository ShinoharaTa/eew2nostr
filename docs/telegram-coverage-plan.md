...
**残っているのは D / F / G の3件。** 取り消し線のものは対応済み。

| # | 課題 | 優先度 | 規模 |
|---|---|---|---|
| ~~A~~ | ~~指定河川洪水予報のコード範囲が足りない~~ **対応済み (#41)** | **高** | 小 |
| ~~B~~ | ~~噴火速報が未対応~~ **対応済み (#42)** | **高** | 小 |
| ~~C~~ | ~~南海トラフ地震臨時情報・後発地震注意情報が未対応~~ **対応済み (#43)** | **高** | 中 |
...
## 5. 課題C: 南海トラフ地震臨時情報 / 北海道・三陸沖後発地震注意情報 — 対応済み (#43)
